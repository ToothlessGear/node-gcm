...
Message.prototype.addNotificationWithKeyValue = function (key, value) {
    console.warn("Message#addNotificationWithKeyValue has been deprecated. Please use Message#addNotification instead.");
    this.addNotification(key, value);
};

Message.prototype.addNotificationWithObject = function (obj) {
    console.warn("Message#addNotificationWithObject has been deprecated. Please use Message#addNotification instead.");
