...
Sender.prototype.sendNoRetry = function(message, recipient, callback) {
    ...
    // Set request options to default to externally-provided options, and override with our own options (allow setting new headers)
    var request_options = _.defaultsDeep(post_options, this.options || {});
