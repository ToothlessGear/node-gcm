...
NotificationKeyOperator.prototype.requestUpdatedKey = function(opts, callback) {
    ...
    **/
    ...
    if (key && key.length && isAddition) operation.operationType = 'add';
    else if (isAddition) operation.operationType = 'create';
