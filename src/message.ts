...
class Message {
  ...
  addNotification<K extends keyof MessageOptions["notification"]>(
    ...
    return this.handleParamSet(
      value !== undefined
        ? [objectOrKey as K, value]
        : [objectOrKey as MessageOptions["notification"]],
      "notification"
    );
  }
  ...
  addData<K extends keyof MessageOptions["data"]>(
    ...
    return this.handleParamSet(
      value !== undefined
        ? [objectOrKey as K, value]
        : [objectOrKey as MessageOptions["data"]],
      "data"
    );
  }
   ...
   */
  addDataWithKeyValue<
    K extends keyof MessageOptions["data"],
    V extends MessageOptions["data"][K]
  >(key: K, value: V) {
    console.warn(
  ...
  private handleParamSet<
    P extends keyof ObjectMessageOptions,
    K extends keyof ObjectMessageOptions[P]
  >(args: [MessageOptions[P]] | [K, MessageOptions[P][K]], paramType: P) {
    if (args.length == 1) {
  ...
  private addOption<
    P extends keyof ObjectMessageOptions,
    K extends keyof ObjectMessageOptions[P]
  >(paramType: P, key: K, value: MessageOptions[P][K]) {
  ...
  private setOption<P extends keyof MessageOptions>(
    paramType: P,
    obj: MessageOptions[P]
  ) {
