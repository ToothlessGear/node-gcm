...
|topic|String|A single publish/subscribe topic. Or multiple topics using the [condition](https://firebase.google.com/docs/cloud-messaging/topic-messaging) parameter.
